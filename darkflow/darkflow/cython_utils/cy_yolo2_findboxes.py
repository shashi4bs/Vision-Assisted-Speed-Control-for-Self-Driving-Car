...
def box_constructor(meta,net_out_in):
    ...
    '''
    #print(type(net_out_in))
    net_out = net_out_in.reshape([H, W, B, int(net_out_in.shape[2]/B)])
    #net_out[:, :, :, ::1]  = np.asarray(net_out_in.reshape([H, W, B, net_out_in.shape[2]/B]),dtype=np.int32)
    #net_out  = np.asarray(net_out_in.reshape([H, W, B, net_out_in.shape[2]/B]),dtype=np.int32)
    Classes = net_out[:, :, :, 5:]
    Bbox_pred =  net_out[:, :, :, :5]
